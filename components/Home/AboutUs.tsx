...
export default function AboutUs() {
  return (
    <section className='py-12 px-[87px] flex flex-col gap-12'>
        <div className='flex flex-col gap-5 items-center'>
            <h1 className='text-[32px] leading-9 font-[500] text-center'>GET HELP</h1>
            <div className='relative flex items-center'>
                <input className='py-5 pl-3 border-[1px] border-solid rounded-[8px] text-[15px] w-[457px]' placeholder='What can we help you with?' type="text" />
                <Image className='absolute right-5' src={search} alt="" />
            </div>
        </div>

        <div className='flex '>
            <div className='flex flex-col gap-8 border-solid pr-7 border-r-[1px] '>
                ...
                <div className=''>
                    ...
                    <div className='flex flex-col gap-5'>
                        ...
                        <div className='flex flex-col gap-2'>
                            ...
                            <p className='text-[16px] leading-7 text-[#111111] w-[842px]'>Yes, we recommend asking your bank to enable international purchases on your card. You will be notified at checkout if international purchases need to be enabled.</p>
                        </div>
            ...
            <div className='w-[313px] flex flex-col gap-10 items-center'>
                <h1 className=' text-[28px] leading-8 text-center font-[500]'>CONTACT US</h1>
