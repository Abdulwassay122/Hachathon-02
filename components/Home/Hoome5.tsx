  ...
  return (
    <section className='py-[84px] px-12 flex flex-col gap-12'>
      ...
      <div className='flex flex-col gap-7 items-center'>
            <h1 className='text-[52px] leading-[60px] text-center font-[500]'>FLIGHT ESSENTIALS</h1>
            ...
            <button className='bg-black rounded-full text-white text-[15px] leading-6 text-center font-[500] w-[80px] h-[39px]'>Shop</button>
        </div>
    </section>
  )
}
